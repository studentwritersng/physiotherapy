...
- [x] **Step 2: Apply locally and verify the constraint exists**
...
- [x] **Step 3: Write the failing constraint test**
...
- [x] **Step 5: Apply the migration to the test database**
...
- [x] **Step 3: Implement `src/lib/slots.ts`**
...
- [x] **Step 3: Implement `src/lib/zod/booking.ts`**
...
- [x] **Step 3: Implement `src/server/services/appointment-status.ts`**
...
- [x] **Step 5: Write the failing transition integration test**
...
- [x] **Step 3: Implement `src/server/services/booking.ts`**
...
- [x] **Step 3: Implement `src/server/services/schedule.ts`**
...
- [x] **Step 2: Update the nav unit test**
...
- [x] **Step 5: Create the agenda page**
...
- [x] **Step 7: Verify typecheck, lint and build**
...
- [x] **Step 1: Write the manual booking actions**
...
- [x] **Step 2: Create the manual booking form and page**
...
- [x] **Step 3: Write the walk-in actions and screens**
...
- [x] **Step 4: Verify typecheck, lint and build**
...
- [x] **Step 2: Create the detail page**
...
- [x] **Step 3: Verify typecheck, lint and build**
...
- [x] **Step 6: Confirm the migration state**
...
- [x] **Step 8: Tick every checkbox in this plan**

Change every `- [x]` to `- [x]` in `docs/superpowers/plans/2026-09-03-booking.md`.
